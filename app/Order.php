...
class Order extends Model
{
    ...
    protected $fillable = ['recipient_name','line1',
        'line2','city','country_code','state','postal_code',
        'email','shopping_cart_id','status','total','guide_number'];



    public function sendMail(){
        Mail::to("braga528@gmail.com")->send(New OrderCreated($this));
    }

    public function sendUpdateMail(){
        Mail::to("braga528@gmail.com")->send(new OrderUpdated($this));
    }

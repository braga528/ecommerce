                                            ...
                                            <tr>
                                                <td valign="top" class="bodyContent">
                                                    <div mc:edit="std_content00">
                                                        <h1 class="h1">Nueva información de pago en Unipesa S.A. de C.V.</h1>
                                                        <strong>¡Hola! {{$order->email}}</strong>
                                                        Te enviamos las actualizaciones de tu compra...
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td valign="top" class="bodyContent">
                                                    <div mc:edit="std_content01">
                                                        Verifica tu información y en caso de de haber un dato erroneo,
                                                        comunicate al correo <a href="gerencia@unipesa.com.mx">gerencia@unipesa.com.mx</a>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                        ...
                                                        <tr>
                                                            <td valign="middle" class="templateButtonContent">
                                                                <div mc:edit="std_content02">
                                                                    <a href="{{url('/compras/'.$order->shoppingCartID())}}" target="_blank">Más información del pedido</a>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                            ...
                                            <tr>
                                                <td valign="top">
                                                    <div mc:edit="std_footer">
                                                        <em>Copyright &copy; 2016 UNIPESA S.A. de C.V. , Todos los derechos reservados.</em>
                                                    </div>
                                                </td>
                                            </tr>
